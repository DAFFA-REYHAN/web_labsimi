...
<body>
    ...
    <nav id="nav" class="navbar navbar-expand-lg navbar-dark bg-dark p-0 fixed-top">
        <div class="container">
            <a class="navbar-brand" href="index.php"><img id="image" src="src/logo_nav_light.png" alt="Logo Navbar" width="200px"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <div class="navbar-nav ms-auto icon d-flex text-end">
                    <a class="nav-link active me-2" aria-current="page" href="https://mail.google.com/mail/u/0/?view=cm&tf=1&to=labsimi2023@email.com" target="_blank">
                    ...
                    <a class="nav-link active me-2" aria-current="page" href="https://www.instagram.com/labsimi_/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="21" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                    ...
                    <a class="nav-link active" aria-current="page" href="https://www.youtube.com/channel/UC9y9b7hSTHw1tAKo4zgTbBQ">
    ...
    <section id="berita" class="bg-light d-flex align-items-center">
        ...
        <div class="container-fluid">
            ...
            <div class="owl-carousel owl-theme">
                ...
                <div class="card mb-3 " style="max-width: 740px;height:195px; ">
                    <button type="button" class="btn btn_modal" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">
                        <div class="row g-0 text-start">
                            ...
                            <div class="col-md-4">
                                <img src="src/Jadwal_Praktikum.png" class="img rounded-start p-1" alt="..." height="100%">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body pe-0">
                                    ...
                                    <p class="card-text mt-3"><small class="text-muted">Last updated 1 months ago</small></p>
                                </div>
                            </div>
                        </div>
                    </button>
                ...
                <div class="card mb-3 " style="max-width: 740px;height:195px; ">
                    <button type="button" class="btn btn_modal px-1" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">
                        <div class="row g-0 text-start">
                            ...
                            <div class="col-md-4">
                                <img src="src/cover_cara_mengirim_laporan_akhir .png" class="img rounded-start p-1" alt="..." height="100%">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body pe-0">
                                    <h5 class="card-title">Tata Cara Mengirim Laporan Akhir</h5>
                                    <div class="text-cover" style="height:77px;overflow-y:hidden" ;>
                                        <p class="card-text mt-1 ">Berikut ini adalah tata cara / langkah- langkah untuk mengirim laporan akhir yang benar. </p>
                                    </div>
                                    <p class="card-text mt-3"><small class="text-muted">Last updated 1 months ago</small></p>
                                </div>
                            </div>
                ...
                <!-- CARD 3 -->
                <div class="card mb-3 " style="max-width: 740px;height:195px; ">
                    <button type="button" class="btn btn_modal" data-bs-toggle="modal" data-bs-target="#staticBackdrop3">
                        <div class="row g-0 text-start">



                            <div class="col-md-4">
                                <img src="src/Cover tata cara berpakaian.png" class="img rounded-start p-1" alt="..." height="100%">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body pe-0">
                                    <h5 class="card-title">Tata Cara Berpakaian dalam Lab</h5>
                                    <div class="text-cover" style="height:77px;overflow-y:hidden" ;>
                                        <p class="card-text mt-1 ">Berikut ini adalah Tata cara berpakaian yang baik dan benar di Laboratorium SI/MI. </p>
                                    </div>
                                    <p class="card-text mt-3"><small class="text-muted">Last updated 1 months ago</small></p>
                                </div>
                            </div>
                    ...
                    <div class="card position-relative card-perlengkapan mb-2 mx-auto" style="width: 18rem;">
                        ...
                        <div class="card-body p-4 mt-4 ">
                            ...
                            <div class="button-lihat text-center">
                                <a href="https://drive.google.com/file/d/1-JQsT38iydN7XKDYvLf2QnpWLeqQDJkK/view" target="_blank" class="btn btn-light text-center">Lihat</a>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card position-relative card-perlengkapan mb-2 mx-auto" style="width: 18rem;">
                        ...
                        <div class="card-body p-4 mt-4 ">
                            ...
                            <div class="button-lihat text-center">
                                <a href="https://drive.google.com/drive/folders/1J6poHzuOU8Gef_4PuKdVYl369zOWjkdV" target="_blank" class="btn btn-light text-center">Lihat</a>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card position-relative card-perlengkapan mb-2 mx-auto" style="width: 18rem;">
                        ...
                        <div class="card-body p-4 mt-4 ">
                            ...
                            <div class="button-lihat text-center">
                                <a href="https://drive.google.com/file/d/1__G-fGueS4TmjvIqY8Ha2dZIN3vBBbl_/view" target="_blank" class="btn btn-light text-center">Lihat</a>
                            </div>
    ...
    <footer class="text-center text-lg-start bg-dark text-muted">
        ...
        <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
            ...
            <!-- Right -->
            <div>
                <a href="https://mail.google.com/mail/u/0/?view=cm&tf=1&to=labsimi2023@email.com" class="me-4 text-reset">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-4">
                        ...
                        <p style="text-align: justify">
                            Informasi bagi mahasiswa lanjutan maupun mahasiswa yang ingin mengulang praktikum, segera lapor ke contact dikanan ini dan jangan lupa siapkan KRS anda. <br>
                            Thanks ! 😊
                        </p>
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-envelope me-3" class="footer_contact"></i> <a href=""> labsimi2023@gmail.com</a></p>
                        <p><i class="fas fa-phone me-3" class="footer_contact"></i> <a href="https://wa.me/6285782694950">+62 857-8269-4950</a> (Fakhri)</p>
                        <p><i class="fas fa-phone me-3" class="footer_contact"></i> <a href="https://wa.me/6287771365424">+62 877-7136-5424</a> (Clarissa)</p>
                        <p><i class="fas fa-phone me-3" class="footer_contact"></i> <a href="https://wa.me/6285881839674">+62 858-8183-9674</a> (Daffa)</p>
                    </div>
                    <!-- Grid column -->
                </div>
                <!-- Grid row -->
    ...
    <!-- MODAL -->
    <!-- Modal Card 1 -->
    <div class="modal modal-xl fade" id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="src/Contents/cara_mengirim_laporan_akhir_1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item ">
                                <img src="src/Contents/cara_mengirim_laporan_akhir_2.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item ">
                                <img src="src/Contents/cara_mengirim_laporan_akhir_3.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item ">
                                <img src="src/Contents/cara_mengirim_laporan_akhir_4.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item ">
                                <img src="src/Contents/cara_mengirim_laporan_akhir_5.jpg" class="d-block w-100" alt="...">
                            </div>
                        </div>
    ...
    <!-- Modal Card 3 -->
    <div class="modal modal-xl fade" id="staticBackdrop3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="text-end py-3 pe-3">
                    <!-- <h5 class="modal-title" id="staticBackdropLabel">Modal title</h5> -->
                ...
                <div class="modal-body">
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img height="100%" src="src/contents/TATA CARA BERPAKAIAN DI DALAM LAB_1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="src/Contents/TATA CARA BERPAKAIAN DI DALAM LAB_2.jpg" class="d-block w-100" alt="...">
                            </div>
