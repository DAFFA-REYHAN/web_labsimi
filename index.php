...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    ...
                    <a class="nav-link me-3" href="#">Struktur</a>
                    <a class="nav-link me-3" href="#">Jadwal</a>
                    <a class="nav-link" href="#">Docs</a>
                </div>
                <div class="navbar-nav ms-auto icon d-flex">
            ...
            <div class="row">
                <div class="col-md-6 offset-1">
                    ...
                    <p class="text-light">Penyajian Informasi seputar <span class="text-warning">Laboratorium<span>
                                Sistem Informasi</p>
                    <a href="http://" class="btn btn-danger ">Hubungi Kami</a>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="owl-carousel owl-theme">
                <div class="card mb-3" style="max-width: 740px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="https://pict.sindonews.net/dyn/620/pena/news/2022/01/13/39/655579/harga-fotofoto-ghozali-bikin-melongo-ada-yang-laku-rp42-miliiar-fwx.jpg"
                                class="img rounded-start" alt="..." height="100%">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                    ...
                    <div class="card position-relative card-perlengkapan mb-2 mx-auto" style="width: 18rem;">
                        ...
                        <div class="card-body p-4 mt-4 ">
                            ...
                            <div class="button-lihat text-center">
                                <a href="" class="btn btn-light text-center">Lihat</a>
                            </div>
    ...
    <script>
        ...
        window.addEventListener('scroll', function () {
            ...
            if (scrollposition >= 590 && scrollposition <= 1260) {
